...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Modalidades e horários de treinos</h3>
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <p class="text-muted">Modalidade masculina e feminina. Treinos terça e quinta.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading">Handebol</h4>
            <p class="text-muted">Modalidade masculina e feminina. Treinos mistos aos sábados.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading">Basket</h4>
            <p class="text-muted">Modalidade masculina. Treinos aos sábados.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!--    <div class="row">-->
    <!--      <div class="col-lg-12 text-center">-->
    <!--        <h2 class="section-heading text-uppercase">Prêmios</h2>-->
    <!--        <h3 class="section-subheading text-muted">Campeonatos e premiações</h3>-->
    <!--      </div>-->
    <!--    </div>-->
    <!--    <div class="row">-->
    <!--      <div class="col-lg-12">-->
    ...
    <!--              <img class="rounded-circle img-fluid" src="img/about/trofeus.jpg" alt="">-->
    <!--            </div>-->
    <!--            <div class="timeline-panel">-->
    <!--              <div class="timeline-heading">-->
    <!--                <h4>2015</h4>-->
    <!--                <h4 class="subheading">Interfatec</h4>-->
    <!--              </div>-->
    ...
    <!--            <div class="timeline-image">-->
    <!--              <img class="rounded-circle img-fluid" src="img/about/fi.jpg" alt="">-->
    <!--            </div>-->
    <!--            <div class="timeline-panel">-->
    <!--              <div class="timeline-heading">-->
    <!--                <h4>2016</h4>-->
    <!--                <h4 class="subheading">Festival Intermodalidade</h4>-->
    <!--              </div>-->
    <!--              <div class="timeline-body">-->
    <!--                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>-->
    <!--              </div>-->
    ...
    <!--          <li>-->
    <!--            <div class="timeline-image">-->
    <!--              <img class="rounded-circle img-fluid" src="img/about/hand-inter.jpg" alt="">-->
    <!--            </div>-->
    <!--            <div class="timeline-panel">-->
    <!--              <div class="timeline-heading">-->
    <!--                <h4>2017</h4>-->
    <!--                <h4 class="subheading">Handebol Masculino - Interfatec</h4>-->
    <!--              </div>-->
    <!--              <div class="timeline-body">-->
    <!--                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>-->
    <!--              </div>-->
    ...
    <!--          <li class="timeline-inverted">-->
    <!--            <div class="timeline-image">-->
    <!--              <img class="rounded-circle img-fluid" src="img/about/sportspa.jpg" alt="">-->
    <!--            </div>-->
    <!--            <div class="timeline-panel">-->
    <!--              <div class="timeline-heading">-->
    <!--                <h4>2017</h4>-->
    <!--                <h4 class="subheading">Futsal feminino - Sportspan</h4>-->
    <!--              </div>-->
    <!--              <div class="timeline-body">-->
    <!--                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>-->
    <!--              </div>-->
